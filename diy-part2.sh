...
sed -i 's/PKG_VERSION:=0.53.2/PKG_VERSION:=0.59.0/' feeds/packages2/net/frp/Makefile
sed -i 's/PKG_HASH:=ff2a4f04e7732bc77730304e48f97fdd062be2b142ae34c518ab9b9d7a3b32ec/PKG_HASH:=eb4848119a9684b7762171d7633aa5ee29d195e63f53e89e7b549096bdf4a5a9/' feeds/packages2/net/frp/Makefile
